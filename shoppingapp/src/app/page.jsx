...
import { GET_ALL_CATEGORIES } from "./graphql/categoryQueries"; // New query
...
const LandingPage = () => {
  ...
  const { data, loading, error } = useQuery(GET_ALL_CATEGORIES, { client });
        ...
        <div className="hero-content-container">
          <div className="hero-content">
            ...
            <p>
              ...
              style. From budget friendly to top of the line.
            </p>
          ...
          {categories.map((category) => (
            <div key={category.id} className="category-card">
              ...
              <Link href={`/category/${category.id}`}>
                <button className="view-category-btn">View Products</button>
              </Link>
            </div>
          ))}
        </div>
